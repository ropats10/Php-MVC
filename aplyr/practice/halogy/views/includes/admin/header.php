    ...
    <head>
        ...
        <script language="JavaScript">
            $(function () {
                $('ul#menubar li').hover(
                        function () {
                            $('ul', this).css('display', 'block').parent().addClass('hover');
                        },
                        function () {
                            $('ul', this).css('display', 'none').parent().removeClass('hover');
                        }
                );
            });
        </script>		
            ...
            <div class="container">
                ...
                <div id="header">
                    ...
                    <div id="logo">
                        ...
                        <?php
                        // set logo
                        if ($this->config->item('logoPath'))
                            $logo = $this->config->item('logoPath');
                        elseif ($image = $this->uploads->load_image('admin-logo'))
                            $logo = $image['src'];
                        else
                            $logo = $this->config->item('staticPath') . '/images/halogy_logo.jpg';
                        ?>
...
<?php if ($this->session->userdata('session_admin')): ?>	
    ...
    <?php if (in_array('events', $this->permission->permissions)): ?>
        ...
        <?php if (in_array('wiki_edit', $this->permission->permissions)): ?>
                                ...
                                <?php if (in_array('users_groups', $this->permission->permissions)): ?>
                                        ...
                                        <?php endif; ?>
    <?php if (in_array('users', $this->permission->permissions)): ?>
                                <li><a href="<?php echo site_url('/admin/links/viewall'); ?>">Links</a>
                                    <ul class="subnav">
                                        <li><a href="<?php echo site_url('/admin/links/viewall'); ?>">Links</a>
                                <?php if (in_array('webforms_edit', $this->permission->permissions)): ?>
                                                <li><a href="<?php echo site_url('/admin/links/link_add'); ?>">Add Links</a></li>
        <?php endif; ?>
                                    </ul>
                                </li>
    ...
    <?php endif; ?>
                                    ...
                                    <?php if (in_array('webforms', $this->permission->permissions)): ?>
                                <li><a href="<?php echo site_url('/admin/plans/viewplans'); ?>">Plans</a>
                                    <ul class="subnav">
                                        <li><a href="<?php echo site_url('/admin/plans/viewplans'); ?>">All Plans</a></li>
                                <?php if (in_array('webforms_edit', $this->permission->permissions)): ?>
                                            <li><a href="<?php echo site_url('/admin/plans/add_plans'); ?>">Add Plans</a></li>
                                            <li><a href="<?php echo site_url('/admin/plans/viewOrders'); ?>">All Orders</a></li>
        <?php endif; ?>
                                    </ul>
                                </li>
    <?php endif; ?>
                                    ...
                                    <?php if (in_array('webforms', $this->permission->permissions)): ?>
                                <li><a href="<?php echo site_url('/admin/testimonial/viewtestimonial'); ?>">Testimonial</a>
                                    <ul class="subnav">
                                        <li><a href="<?php echo site_url('/admin/testimonial/viewtestimonial'); ?>">All Testimonial</a></li>
                                <?php if (in_array('webforms_edit', $this->permission->permissions)): ?>
                                            <li><a href="<?php echo site_url('/admin/testimonial/add_testimonial'); ?>">Add Testimonial</a></li>
